# -*- coding: utf-8 -*-
"""DataStorm_4_0 - Gunshumal.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1dwcvy87NkwoTQ6gmFK9PNhGXEW8NWWG9
...
rawHisTransDF=pd.read_csv('E:\Projects and competitions\Data storm 4.0\DataStorm-4.0\stormingRoundDay_3\Historical-transaction-data.csv')
rawStoreInfDF=pd.read_csv('E:\Projects and competitions\Data storm 4.0\DataStorm-4.0\stormingRoundDay_3\Store-info.csv')
rawTestDF=pd.read_csv('E:\Projects and competitions\Data storm 4.0\DataStorm-4.0\stormingRoundDay_3\Testing-data.csv')
...
def custom_scorer(y_true, y_pred):
    ...
    formatted_f1_average = "{:.2f}".format(f1_average)
...
best_model = None
best_score = 0.0
my_score = make_scorer(custom_scorer, greater_is_better=True)
